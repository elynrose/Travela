    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="{{ route('itineraries.update', $itinerary) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Bootstrap Nav Tabs -->
                <ul class="nav nav-tabs mb-4" id="editItineraryTabs" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="travel-tab" data-bs-toggle="tab" data-bs-target="#travel" type="button" role="tab" aria-controls="travel" aria-selected="false">Travel Information</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="gallery-tab" data-bs-toggle="tab" data-bs-target="#gallerytab" type="button" role="tab" aria-controls="gallerytab" aria-selected="false">Gallery Photos</button>
                  </li>
                </ul>

                <div class="tab-content" id="editItineraryTabsContent">
                  <!-- Basic Info Tab -->
                  <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                    <div class="row g-4">
                      ...
                      <!-- Basic Information (title, description, location, country, price, categories, highlights, included/excluded items, requirements, publish) -->
                      <div class="col-md-8">
                        <div class="mb-4">
                      ...
                      <!-- Highlights, Included/Excluded Items, Requirements, Publish -->
                      <div class="col-12">
                        <div class="mb-4">
                  ...
                  <div class="tab-pane fade" id="travel" role="tabpanel" aria-labelledby="travel-tab">
                    <div class="card shadow-sm mb-4">
                      <div class="card-body">
                        ...
                        <div class="row g-3">
                          <!-- (copy all travel info fields here from original form) -->
                          <div class="col-md-6">
                            ...
                            <div class="row g-2">
                              @foreach($itinerary->gallery as $image)
                                <div class="col-md-3 position-relative">
                                  ...
                                  <div class="bg-light rounded d-flex align-items-center justify-content-center" style="height: 100px; width: 100px; display: none;">
