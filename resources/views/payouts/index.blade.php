                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900">${{ number_format($totalEarned, 2) }}</div>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900">${{ number_format($pendingPayouts, 2) }}</div>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($payouts as $payout)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $payout->processed_at ? $payout->processed_at->format('M d, Y H:i') : '-' }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
